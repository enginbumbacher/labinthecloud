        ...
        this.experiments.forEach(function (exp) {
          if (exp.status == 'running') {
            if (now - exp.startTime < _this2.demoLength * 1000) {
              ...
              Promise.all([Utils.promiseAjax('/cslib/module/euglena/demodata/58c82d732288ca69a5319aab.json'), Utils.promiseAjax('/cslib/module/euglena/demodata/tracks.json')]).then(function (downloads) {
                exp.data = {

...
class BaseFields extends FieldGroup {
  constructor(conf) {
    ...
    let urlBase = `${window.location.origin}/lab/${owner.domain ? owner.domain : owner.uuid}/&lt;project url&gt;/`;
      ...
      modelData: {
        ...
        fields: [
          ...
          TextField.create({
            ...
            label: "URL",
            prefix: urlBase,
            help: `<small>You can change your base URL in your <a href="/admin/account/change-domain">Account settings</a>. To get the final URL for each lab, see the Info page for your <a href="/admin/studentgroups">Projects</a></small>`,
            required: true,
            validation: {
              custom: {

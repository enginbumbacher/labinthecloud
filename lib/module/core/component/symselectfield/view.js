define((require) => {
  ...
  return class SymSelectFieldView extends BaseFieldView {
    ...
    _addVariationPopUp(model) {
      ...
      let popup_message = 'Variation means that some models can have a ' + model.get('label').toLowerCase() + ' that is bigger or smaller than the average value you picked. The bigger the variation the bigger the differences between models.';

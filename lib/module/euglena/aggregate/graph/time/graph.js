define((require) => {
  ...
  class AggregateTimeGraph extends Component {
    constructor(settings) {
      ...
      this._model.addEventListener('AggregateTimeGraph.EnableRequest', this._onEnableRequest);
      this._model.addEventListener('AggregateTimeGraph.DisableRequest', this._onDisableRequest);
    }

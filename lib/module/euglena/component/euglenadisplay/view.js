...
import Template from './euglenadisplay.html';
import Globals from 'core/model/globals';

// let referenceBall = new THREE.Mesh(
//   new THREE.SphereGeometry(5, 12, 12),
//   new THREE.MeshLambertMaterial({ color: 0x990000 })
// );

export default class EuglenaDisplayView extends DomView {
  constructor(model, tmpl) {
    ...
    this.lights = {
      ...
      global: Globals.get('AppConfig.system.testMaterial') ? new THREE.AmbientLight(0xffffff, 1.0) : new THREE.AmbientLight(0xffffff, 0.6)
    }

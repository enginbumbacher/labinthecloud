...
class VisualResult extends Component {
  constructor(config) {
    ...
    '_onSliderRequest','_onStopDrag','_onShowVideo','_onPlaybackRateRequest','disableVideoControls','enableVideoControls']);
  ...
  destroy() {
    Globals.get('Relay').removeEventListener('VisualResult.PlayPauseRequest', this._onPlayPauseRequest);
    Globals.get('Relay').removeEventListener('VisualResult.PlaybackRateRequest', this._onPlaybackRateRequest);
    Globals.get('Relay').removeEventListener('VisualResult.ResetRequest', this._onResetRequest);
    Globals.get('Relay').removeEventListener('VisualResult.SliderRequest', this._onSliderRequest);
    Globals.get('Relay').removeEventListener('VisualResult.StopDrag', this._onStopDrag);

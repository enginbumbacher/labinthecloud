define((require) => {
  ...
  return class ExperimentForm extends Form {
    constructor() {
      ...
      // Utils.bindMethods(this, ['_onDryRun', '_onSubmit']);

      // this.view().addEventListener('Experiment.DryRun', this._onDryRun);
      // this.view().addEventListener('Experiment.Submit', this._onSubmit);
    }

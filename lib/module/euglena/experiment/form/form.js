            ...
            validation: {
              custom: {
                ...
                fn: (val) => {
                  ...
                  return Promise.resolve(total == Globals.get('AppConfig.experimentLength'));
                },
                errorMessage: `Total experiment duration must be exactly ${Globals.get('AppConfig.experimentLength')} seconds.`
              }
            }
          })],

...
export default class ExperimentForm extends Form {
  constructor() {
    ...
    var availableCategories = defaultCategories;
    if (Globals.get('AppConfig.experiment.formOptions').length) {
      if (Object.keys(Globals.get('AppConfig.experiment.formOptions')).indexOf('exp_category') > -1) {
        Globals.get('AppConfig.experiment.formOptions')['exp_category'].forEach((expOption) => {
          if (Object.keys(defaults).indexOf(expOption)==-1) {
      ...
      modelData: {
        ...
        fields: [
          ...
          ExpProtocol.create({
            ...
            defaultValue: 'default_choice',
            classes:[],
            options: {'default_choice': 'please choose one', 'fix_dir_constant_10': '10%', 'fix_dir_constant_20': '20%', 'fix_dir_constant_40': '40%', 'fix_dir_constant_60': '60%', 'fix_dir_constant_80': '80%', 'fix_dir_constant_100': '100%',
          ...
          'simple_seq_around': '5. How many steps in the sequence?', 'simple_seq_2alternates': '5. How many steps in the sequence?', 'complex_seq': '5. What additional light direction?'},
            ...
            defaultValue: 'default_choice',
            classes:[],
            options: {'default_choice': 'please choose one', 'simple_seq_alternate_right': 'from the right', 'simple_seq_alternate_bottom': 'from the bottom', 'simple_seq_alternate_nolight': 'no light',

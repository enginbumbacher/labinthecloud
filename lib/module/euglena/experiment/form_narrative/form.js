      ...
      modelData: {
        ...
        fields: [
          ...
          ExpProtocol.create({
            ...
            defaultValue: 'default_choice',
            classes:[],
            options: {'default_choice': 'please choose one', 'simple_seq_alternate_4': '4 steps', 'simple_seq_alternate_6': '6 steps', 'complex_seq_10': '10%', 'complex_seq_20': '20%', 'complex_seq_40': '40%', 'complex_seq_60': '60%'},
            validation: {}
          })
        ],
        buttons: buttons

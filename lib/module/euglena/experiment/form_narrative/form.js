...
const defaults = {
  ...
  'simple_seq': 'Simple light sequence',
      ...
      modelData: {
        ...
        fields: [
          ...
          ExpProtocol.create({
            ...
            'simple_seq_around': 'Make the light go around', 'simple_seq_alternate': 'Alternate between two single directions', 'simple_seq_2alternates': 'Alternate between two complex directions',
        ...
        'simple_seq_around_simple_seq_2alternates_4': '4 steps', 'simple_seq_around_simple_seq_2alternates_6': '6 steps' },
            validation: {}
          }),
          ExpProtocol.create({
            ...
            defaultValue: 'default_choice',
            classes:[],
            options: {'default_choice': 'please choose one', 'simple_seq_alternate_4': '4 steps', 'simple_seq_alternate_6': '6 steps', 'complex_seq_10': '10%', 'complex_seq_20': '20%', 'complex_seq_40': '40%'},
            validation: {}
          })
        ],
        buttons: buttons

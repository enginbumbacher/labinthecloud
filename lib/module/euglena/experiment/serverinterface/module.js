...
//    if (loadData === 'experiment') {
  ...
  destroy() {
    Globals.get('Relay').removeEventListener('ExperimentServer.ExperimentRequest', this._onExperimentRequest);
    Globals.set('euglenaServerMode', null);
    return Promise.all([this.connector.destroy(), super.destroy()]);
  }
}

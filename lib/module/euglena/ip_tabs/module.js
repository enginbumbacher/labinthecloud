...
export default class InteractiveTabsModule extends Module {
  constructor(ctx) {
    super(ctx);
    Utils.bindMethods(this, ['_onPhaseChange', '_onTabRequest', '_onDisableRequest', '_onEnableRequest','_toggleTabs', '_hookTabSwitch']);
    ...
    HM.hook(`${this.context.app}.IPTabSwitch`, this._hookTabSwitch);
  }
  ...
  _hookTabSwitch(subj, meta) {
    return Promise.resolve(this._tabs.selectTab(meta.tabId));
  }
  ...
  destroy() {
    ...
    HM.unhook(`${this.context.app}.IPTabSwitch`, this._hookTabSwitch);

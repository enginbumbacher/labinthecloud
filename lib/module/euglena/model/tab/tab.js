...
class ModelTab extends Component {
  constructor(settings = {}) {
    ...
    if (this._model.get('modelType') == 'blockly') {
      ...
      var paramOptions = {
        reaction: Object.keys(this._form.getField('k').getOptions()),
        motor: Object.keys(this._form.getField('v').getOptions())
      }
      if (this._model.get('parameters').omega) {
        paramOptions.roll = Object.keys(this._form.getField('omega').getOptions());
      } else if (this._model.get('parameters').motion) {
        paramOptions.motion = Object.keys(this._form.getField('motion').getOptions());
      }

  ...
  class ModelTab extends Component {
    constructor(settings = {}) {
      ...
      if (this._model.get('modelType') == 'blockly') {
        ...
        paramOptions['forward'] = Object.keys(this._model.get('parameters').v.options)
        paramOptions['roll'] = Object.keys(this._model.get('parameters').omega.options)
        this.bodyConfigurations = BodyConfigurations.create({initialConfig: initialBody, paramOptions: paramOptions, modelModality: this._model.get('modelModality')})

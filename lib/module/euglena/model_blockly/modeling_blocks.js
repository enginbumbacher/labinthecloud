...
window.Blockly.Blocks['master_block'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Put all the programming blocks in here:");
...
window.Blockly.Blocks['see_light'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("If there is a light signal, do:");
    this.appendStatementInput("CODE")
        .setCheck(null);
    this.setInputsInline(false);
...
window.Blockly.Blocks['no_light'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("If there is no light signal, do:");
    this.appendStatementInput("CODE")
        .setCheck(null);
    this.setInputsInline(false);
    this.setPreviousStatement(true,null);
...
window.Blockly.Blocks['either_way'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("With or without a light signal, do:");
    this.appendStatementInput("CODE")
        .setCheck(null);
    this.setInputsInline(false);
    this.setPreviousStatement(true,null);

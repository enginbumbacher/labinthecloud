...
class ModelingDataModule extends Module {
  ...
  '_hookModelFields', '_hookModifyExport', '_hookModifyImport', '_hook3dView','_hookExtractData'])
  ...
  _hookModelFields(fields, meta) {
    if (meta.parameterForm) {
      this.parameterForm = meta.parameterForm;
    }

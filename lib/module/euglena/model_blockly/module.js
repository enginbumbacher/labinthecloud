...
class ModelingDataModule extends Module {
  constructor(ctx) {
    ...
    Utils.bindMethods(this, ['_onPhaseChange', '_onExperimentCountChange', '_hookModelFields', '_hookModifyExport', '_hookModifyImport', '_hook3dView', '_hookBlocklyConfigurations'])
    ...
    if (meta.type == "blockly") {
      ...
      if (meta.config.k.visible) {
        fields.push(SymSelectField.create({
          ...
          inverse_order: true,
          varOptions: meta.config.k.variation ? (meta.config.k.varOptions || {'variation_0': 'no', 'variation_10': 'small', 'variation_25': 'medium', 'variation_50': 'large'}) : null,
      ...
      if (meta.config.omega) {
        ...
        if (meta.config.omega.visible) {
          omegaField = SymSelectField.create({
            ...
            inverse_order: true,
            varOptions: meta.config.omega.variation ? (meta.config.omega.varOptions || {'variation_0': 'no', 'variation_10': 'small', 'variation_25': 'medium', 'variation_50': 'large'}) : null,

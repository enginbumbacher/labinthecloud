define((require) => {
  ...
  return class ResultsModule extends Module {
      ...
      if (evt.data.directModelComparison) { // Load experiment into the second video view for model comparison when activated for the first time
        ...
        if (evt.data.experiment.id != '_new') {
          ...
          EugUtils.getLiveResults(loadExpId).then((results) => {
            ...
            if (Globals.get('AppConfig.system.expModelModality') === 'sequential') { console.log('onExpLoaded'); this._view.showVideo(true);}
            else if (Globals.get('AppConfig.system.expModelModality') === 'justmodel') {console.log('onExpLoaded');  this._view.showVideo(true);}
        ...
        if (Globals.get('AppConfig.system.expModelModality') === 'justmodel') {console.log('onExpLoaded');  this._view.showVideo(false);}
      }
    }
    ...
    _onModelLoaded(evt) {
      ...
      */
      if (Globals.get('AppConfig.system.expModelModality') == 'sequential') { console.log('onModLoaded'); this._view.showVideo(false);}
      else if (Globals.get('AppConfig.system.expModelModality') == 'justmodel') { console.log('onModLoaded'); this._view.showVideo(false);}
    ...
    _onModelResultsRequest(evt) {
      if (evt.data.tabId == 'none') {
        ...
        if (Globals.get('AppConfig.system.expModelModality') === 'sequential') { console.log("onModelResultRequest"); this._view.showVideo(true);}
        else if (Globals.get('AppConfig.system.expModelModality') === 'justmodel') {console.log("onModelResultRequest"); this._view.showVideo(false);}
        ...
        if (currModel) {
          ...
          if (Globals.get('AppConfig.system.modelModality')!='create') { Globals.get('Relay').dispatchEvent('Model.AutomaticSimulate',{tabId: evt.data.tabId}); }
        }

...
export default class ResultsView extends DomView {
  constructor(tmpl) {
    super(tmpl || Template);
    Utils.bindMethods(this, ['_onTick', '_onVisualizationChange', '_onModelChange', 'activateModelComparison', '_moveTabs']);
  ...
  reset() {
    this.clear();
    if (this._modelSelect) { this._modelSelect.setValue('none'); }
